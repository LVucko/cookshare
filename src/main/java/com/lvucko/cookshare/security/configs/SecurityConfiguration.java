    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/recipes/*/favourite").hasAnyAuthority(Role.USER.name(), Role.MODERATOR.name(), Role.ADMIN.name())
                        .requestMatchers(HttpMethod.POST, "/api/recipes/*/favourite").hasAnyAuthority(Role.USER.name(), Role.MODERATOR.name(), Role.ADMIN.name())
                        .requestMatchers(HttpMethod.DELETE, "/api/recipes/*/favourite").hasAnyAuthority(Role.USER.name(), Role.MODERATOR.name(), Role.ADMIN.name())
